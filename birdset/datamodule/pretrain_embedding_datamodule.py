...
class PretrainEmbeddingDataModule(EmbeddingDataModule, PretrainDataModule):
    def __init__(
            self,
    ...
    def num_classes(self):
        return super(PretrainDataModule, self).num_classes
    ...
    def prepare_data(self):
        ...
        if os.path.exists(self.embeddings_save_path):
            ...
            dataset = PretrainDataModule._preprocess_data(self, dataset)
